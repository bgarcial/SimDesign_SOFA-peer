...
void ZMQClientComponent::setupConnection()
{
    ...
    const string localPublisherEndpoint = "tcp://localhost:5557";
    ...
    */
    ...
    const string localPushEndpoint = "tcp://localhost:5558";
    /**
     * Connecting to publisherEndpoint and pushEndpoint
    */
    cout << "Connecting to ZMQ Network Manager   " << localPublisherEndpoint << "..." << endl;
    // subscriber.connect("tcp://ec2-34-239-214-140.compute-1.amazonaws.com:5557");

    subscriber.connect("tcp://localhost:5557");

    // subscriber.connect("tcp://10.105.18.233:5557");
